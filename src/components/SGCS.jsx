...
export const SGCS = () =>{
    ...
    return(
        <main>
            ...
            <img src={codigo} width={500} height={300} alt="" class="codigo" />
            ...
            <p>
                se centra en la estructura interna del código, verificando el flujo lógico, las condiciones y los caminos posibles. 
                Requiere conocimientos de programación y permite identificar errores ocultos en la lógica o estructuras mal implementadas.
            </p>
            ...
            <p>
                se enfoca en la funcionalidad del software sin considerar el código interno. El evaluador ingresa datos
                y valida que las salidas sean las esperadas, asegurando que el sistema cumpla los requisitos funcionales definidos.
            </p>

            
            

            <h3>•PRUEBA UNITARIA</h3>
            <p>
            ...
            <p>
                Examinan el código fuente para detectar malas prácticas, vulnerabilidades o posibles fallos antes de ejecutar el software.
                Ejemplos son SonarQube, que permite el análisis estático del código, y Selenium, que facilita la automatización de pruebas funcionales en aplicaciones web. Además, herramientas como Jira y Trello complementan este proceso al gestionar incidencias, organizar tareas y dar trazabilidad al ciclo de vida del software
